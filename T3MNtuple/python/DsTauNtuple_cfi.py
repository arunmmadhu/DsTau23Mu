...
T3MTree = cms.EDAnalyzer('T3MNtuple',
                         ...
                         doFullMC = cms.bool(True),   # Set in other instance, here only for local tests
                         doL1 = cms.bool(True),
                         ...
                         DataMCType    = cms.untracked.string('b0_tau'), #Defaut: data. Have a look at src/DataMCType.cc for available types   Set in other instance, here only for local tests
